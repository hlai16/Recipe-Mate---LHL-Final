    ...
    <section>
      <section className="navDiv">
        <Navbar bg="white" expand="lg" sticky="top">
          <Navbar.Brand><Link to={'/user_profile'} className="nav-link"><img src="https://github.com/hlai16/Recipe-Mate---LHL-Final/blob/feature/search-index/public/images/logo.png?raw=true" alt="logo" width="100"></img></Link></Navbar.Brand>
